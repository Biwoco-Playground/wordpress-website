        ...
        <h2 class="nav-tab-wrapper">
            <?php for ($counter = 1; $counter <= 5; $counter++) {
                ...
                <a class="nav-tab<?php echo $class; ?>" href="<?php echo
                                                                ...
                                                                ?>"><?php echo $counter; ?><?php if ($temp_options !== false)
...
(Empty)'; ?></a>
        ...
        <form name="ch2te_options_form" method="post" action="admin-post.php">
            ...
            <table>
                <tr>
                    <td>Setting name</td>
                    <td><input type="text" name="setting_name" value="<?php echo esc_html($options['setting_name']); ?>" />
                    </td>
                </tr>
                <tr>
                    <td>Feed width</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="number_of_tweets" value="<?php echo esc_html($options['number_of_tweets']); ?>" /></td>
                </tr>
            </table><br />
